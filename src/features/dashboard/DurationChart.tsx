...
import { BookingDetailsType } from "@/types/supabase.types";
...
function prepareData(startData: StartDataType[], stays: BookingDetailsType[]) {
...
type DurationChartProps = {
  confirmedStays: BookingDetailsType[];
};
